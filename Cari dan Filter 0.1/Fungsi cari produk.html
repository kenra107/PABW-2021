...
<?php
    ...
    if ($_POST[tulis_produk] <>
null) { if(isset($_POST['cari_produk'])){ $i=1; $ambildata = mysqli_query($cari,"select nama_produk from ..."); while($export = mysqli_fetch_array($ambildata)){ if($_POST[tulis_produk] == $export[nama_produk]) echo"
<tr>
